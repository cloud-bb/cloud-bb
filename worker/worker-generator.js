...
const jsURL = 'https://raw.githubusercontent.com/bulumonyet/G-Drivex/master/worker/worker-beta.js';

async function handleRequest(request) {
    let title = getParameterByName(request.url, 'site_name') || 'G-Drive Index';
...
<head>
    ...
    <title>G-Drive Index - Beta</title>
...
<div class="mdui-container">
    ...
    <center><h5>© 2020 - C3-Systems</h5></center>
</div>
