...
const uiConfig = {
	...
	"version": "6.6.6", // don't touch this one. get latest code using generator at https://github.com/bulumonyet/G-Drivex
	"logo_image": false, // true if you're using image link in next option.
	"logo_height": "", // only if logo_image is true
	"logo_width": "100px", // only if logo_image is true
	"logo_link_name": "G-Drive", // if logo is true then link otherwise just text for name
	"contact_link": "https://source-code.my.id", // Link to Contact Button on Menu
	"copyright_year": "2050", // year of copyright, can be anything like 2015 - 2020 or just 2020
	"company_name": "C3-Cloud", // Name next to copyright
	"company_link": "https://source-code.my.id", // link of copyright name
...
<head>
  ...
  <link rel="icon" href="https://cdn.jsdelivr.net/gh/bulumonyet/G-Drivex/images/favicon.ico">
  <script>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/bulumonyet/G-Drivex/css/mdui-style.min.css">
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/bulumonyet/G-Drivex/css/bootstrap/${uiConfig.dark_mode ? 'dark' : 'light'}.min.css">
  <style>${uiConfig.display_size ? '' : '.csize{display:none;}'}${uiConfig.display_time ? '' : '.cmtime{display:none;}'}</style>
  <script src="https://cdn.jsdelivr.net/gh/bulumonyet/G-Drivex/js/app.min.js"></script>
  <script src="https://cdn.jsdelivr.net/gh/bulumonyet/G-Drivex/js/mdui.min.js"></script>
  <script src="//cdn.jsdelivr.net/npm/markdown-it@10.0.0/dist/markdown-it.min.js"></script>
</head>
<body>
</body>
<script src="https://cdn.jsdelivr.net/gh/bulumonyet/G-Drivex/js/bootstrap.min.js"></script>
</html>`;
};
